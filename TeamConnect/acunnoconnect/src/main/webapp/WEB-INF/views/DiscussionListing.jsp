<html>
<head>
<title>AcunnoConnect - Messages</title>
	...
	<div class="h-top" id="home">
		<div class="top-header">
			...
			<ul class="cl-effect-16 top-nag">
				<li><a href="javascript:void[0]" onclick="logoutUserAction()"
					data-hover="Login">Logout</a></li>
			</ul>
	...
	<div class="full">
		<div class="col-md-3 top-nav sing-page">
			...
			<div class="top-menu">
				...
				<ul class="cl-effect-16">
					<li><a class="active" href="javascript:void[0]" onclick="populateGroupMessagesForUser()" data-hover="HOME">GroupMessages</a></li>
					<li><a href="about.html" data-hover="About">Mails</a></li>
					<li><a href="javascript:void[0]" data-hover="CONTACT" onclick="managegroups()">Groups</a></li>
					<li><a href="contact.html" data-hover="CONTACT">Users</a></li>
					<li><a href="services.html" data-hover="Services">Documents</a></li>
				</ul>
				<!-- script-for-nav -->
				<script>
		...
		<div class="col-md-9 main">
			...
			<div class="banner-section">
				...
				<div class="dropdown dropdown-groupmsg" id="groupmessageoptions_dd">
				...
				<button class="btn" type="button" onclick="postnewmessage()" id="postnewgroupmessage_btn">Post Message</button>
				...
				<!-- START BLOCK FOR HIDDEN VARIABLES  -->
				<input type="hidden" name="loggedInUserRole" id="loggedInUserRole"
					value=<c:out value="${loggedInUserRole}"></c:out> /> <input
					type="hidden" name="loggedInUserId" id="loggedInUserIdVar"
					value=<c:out value="${loggedInUserId}"></c:out> /> <input
					type="hidden" name="loggedInUserGroupId"
					id="loggedInUserGroupIdVar"
					value=<c:out value="${loggedInUserGroupId}"></c:out> />
				<!-- END BLOCK FOR HIDDEN VARIABLES -->




				<div class="clearfix"></div>
				<div id="applicationcontentpane" class="applicationcontent">
					<div class="selectedheadertitle">
						<h3 class="tittle">
							<span id="selectedMenuHeader">Group Messages</span> <i
								class="glyphicon glyphicon-inbox"></i>
						</h3>
					</div>
				<div id="applicationscontainer"> 
				</div> <!-- DIV Closed for questions container -->
				</div>
			</div>
			<!--//banner-->
			<!--//banner-section-->
				...
				<div class="general-news">
					<div class="general-inner">
						<div class="general-text">
							<a href="#"><img src="images/gen1.jpg" class="img-responsive"
								alt=""></a>
							<h5 class="top">
						...
						<div class="media">
							...
							<div class="general-text two">
								<a href="#"><img src="images/gen3.jpg"
						...
						<div class="general-text two">
							<a href="#"><img src="images/gen2.jpg" class="img-responsive"
								alt=""></a>
							<h5 class="top">
								<a href="#">Consetetur sadipscing elit</a>
							</h5>
			...
			<div class="copy">
				<p>
					&copy; 2016 Blogger. All Rights Reserved | Design by <a
